...
@endif
<!--@if($contact->passport_picture)-->
<!--    <strong><i class="fa fa-image margin-r-5"></i> ID/Password Picture</strong>-->
<!--    <p class="text-muted">-->
<!--        <a href="{{ asset($contact->passport_picture) }}" target="_blank">-->
<!--            <img src="{{ asset($contact->passport_picture) }}" width="200" class="mt-2">-->
<!--        </a>-->
<!--    </p>-->
<!--@endif-->